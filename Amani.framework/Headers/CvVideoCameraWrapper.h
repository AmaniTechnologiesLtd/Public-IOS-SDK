...
@protocol FeatureMatchResultDelegate <NSObject>
- (void)featureMatchResult: (NSDictionary *) result;
@end
 ...
 */
@property (nonatomic, weak) id <FeatureMatchResultDelegate> delegate;

-(id)initWithImageView:(UIImageView*)iv docType:(NSString*)type;
/// Start the camera.
-(void)startCamera;
/// Stop the camera.
-(void)stopCamera;
-(void) amaniFunction;
-(void) amaniStopFunction;
@end
